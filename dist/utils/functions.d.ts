 ...
 */
export declare function useUrlData(url: string, showMessage?: boolean): Promise<any>;
/**
 ...
 * @return {Promise<any>} Promise<ข้อมูล>.
 */
export declare function useExampleUrlData(showMessage?: boolean): Promise<any>;
